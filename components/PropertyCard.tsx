    ...
    <Link href={`/properties/${property.slug}`} className="block h-full">
      ...
      >
        <div className="relative aspect-[4/3] overflow-hidden">
          ...
          <div
            className={`absolute bottom-3 left-3 text-white text-xs font-bold px-2 py-1 rounded z-10 ${property.type === "sale" ? "bg-nordic-dark/90" : "bg-mosque/90"}`}
          >
            {property.type === "sale" ? t('property.for_sale') : t('property.for_rent')}
          </div>
        </div>
